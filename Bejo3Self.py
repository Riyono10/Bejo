...
ki = LINETCR.LINE() #via1
ki.login(token="Epd8NOtbiIPLSPlKHDq9.yx+t2VJzkRNdlPU2RlUb2q.1dWOBOlb6k7JTun/D63LBQ0Pn1tysjH9FlEUtubLiG8=")
ki.loginResult()

kk = LINETCR.LINE() #via2
kk.login(token="EpUYKVFnuXBM7sr3NLZa.Dhdy2GKcCS4nNmLJCaNpcG.04Dej1BWj4wBEPLj/m94WRh38pwbfjXMdHMSLVYn2Aw=")
kk.loginResult()

kc = LINETCR.LINE() #via3
kc.login(token="EpVIVzBoFsdiDvOA2JP6.l1sUJRZN2Plp7X7G+jey9G.JSzIF2WGYaKt6Cmefjh7TfZaoD2orDjh1n1YNwUdEWg=")
kc.loginResult()

ks = LINETCR.LINE() #via4
ks.login(token="EpPpeybcGoR2bQYb6fJ6.NXd37ScSBDLnUL5NT3eDfG.mzgqMmW/UBK8ZqV6kfzAU2bNOEtcUBWsKyuropWs0G4=")
ks.loginResult()

ka = LINETCR.LINE() #via5
ka.login(token="Eps0UrAaWlRZINyiadb0.jvg1Tro60ccaX1JDl6HsCa.5zeJ7ROgg9uRdUBq6BMwzJGYOu1/JvO9BI4NmDygX2w=")
ka.loginResult()

print "login success omm"
reload(sys)
  ...
  #------Joined User Kick start------#
                    ...
                    if msg.text is not None:
                        ...
                        if data['status'] == 200:
                            if data['result']['result'] == 100:
                                cl.sendText(msg.to, "[RADISTI TEAM ] " + "\n" + data['result']['response'].encode('utf-8'))
    ...
    #--------------- Lawan atau Whitelist -------
              ...
              if whitelist == []:
                  ...
                  #cl.sendText(msg.to,"Tunggu...")
                  mc = "👥Whitelist RADISTI TEAM PROTECT 👥\n𖤓≛≛≛≛≛≛≛≛≛≛≛≛≛≛≛≛𖤓\n"
        ...
        #----------------Fungsi Banned Kick Target Finish----------------------#                
              ...
              if msg.from_ in owner:
                if msg.toType == 2:
                    ...
                    #cl.sendText(msg.to,"🔱RADISTI TEAM PROTECT🔱 Mau Bersih² Group Sampah Nih")
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
            if hasil['result']['posts'][zx]['userInfo']['mid'] in owner:
                try:
                    ...
                    cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto like by : RADISTI TEAM PROTECT҉\nStatus Boss udah Kami Like\nOwner Kami :\nriyono10")
                    print "Like"
                except:
                    pass
            else:
