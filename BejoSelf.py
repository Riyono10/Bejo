  ...
  #------Joined User Kick start------#
        ...
        if op.type == 19:
           if op.param2 not in admin:
                ...
                kl.acceptGroupInvitationByTicket(op.param1)
                time.sleep(0.2)
                kl1.acceptGroupInvitationByTicket(op.param1)
                time.sleep(0.2)
                targets = []
                for s in G.members:
                ...
                if targets ==[]:
                    ...
                    for target in targets:
                        try:
                            kl.kickoutFromGroup(op.param1,[target])
                            kl1.kickoutFromGroup(op.param1,[target])
                            cl.inviteIntoGroup(op.param1,[op.param3])
    ...
    for zx in range(0,50):
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
            if hasil['result']['posts'][zx]['userInfo']['mid'] in owner:
                ...
                print "Status Sudah di Like Broo"
